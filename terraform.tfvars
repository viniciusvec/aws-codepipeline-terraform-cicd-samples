...
create_new_role    = true                                                        # won't be needed with git
#codepipeline_iam_role_name = "iacCodePipelineRole"
#<Role name> - Use this to specify the role name to be used by codepipeline if the create_new_role flag is set to false.
stage_input = [
